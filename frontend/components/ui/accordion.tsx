...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-2 px-3 py-2.5 text-sm font-medium transition-all hover:bg-accent/40 [&[data-state=open]>svg.accordion-chevron]:rotate-180",
        className,
      )}
      {...props}
    >
